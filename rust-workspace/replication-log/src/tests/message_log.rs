...
// use crate::{
//     channel_subscriber::ChannelSubscriber, chat_client::MessageLog, ChatMessage, MessageStream,
// };
...
//     let chat_client = MessageLog::new(Arc::new(mock_channel_subscriber.clone()));
